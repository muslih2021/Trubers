...
const DetailModalUser = forwardRef(({ isOpen, closeModal, user }, ref) => {
      ...
      >
        ...
        <form className='relative'>
          <div className=''>
            ...
            <div className='md:flex flex-column py-8 align-items-start  gap-4 px-4'>
          ...
          <div className='py-4 border-round-3xl w-12 mt-8 flex gap-6 flex-order-1 px-4   flex-column '>
            ...
            <div className='w-12 flex gap-4'>
              <Button
                ...
                onClick={() => {
                  if (user?.linkmedsos) window.open(user.linkmedsos, '_blank');
                }}
              />
            </div>
          </div>
