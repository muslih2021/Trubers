			...
			>
				<div className="md:w-9 md:-mt-8 fadeinup  animation-duration-2000  align-items-center md:-ml-8 flex md:-mt-8  md:mb-8">
					<img
						src={logo}
						alt=""
						className="md:w-3rem w-2rem md:h-3rem  h-2rem "
					/>
					<h1
						style={{ wordSpacing: "-1px", letterSpacing: "-0.15rem" }}
				...
				>
					Silakan Buat Password Baru Untuk Mengganti Password Lama Anda!
				</p>
				...
				<Button
					disabled={loading}
					label={loading ? "Loading....." : "Konfirmasi"}
					type="submit"
